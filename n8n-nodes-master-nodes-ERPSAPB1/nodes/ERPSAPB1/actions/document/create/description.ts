...
import {
    documentWithLinesResources,
    downPaymentDocumentResources,
    managedDocumentResources,
    paymentDocumentResources,
} from '../constants';
...
export const documentCreateDescription: INodeProperties[] = [
    ...
    },
    {
        ...
        displayOptions: {
            show: {
                resource: documentWithLinesResources,
                operation: [
                    'create',
                ],
                payloadMode: [
    ...
    },
    {
        ...
        displayOptions: {
            show: {
                resource: downPaymentDocumentResources,
                operation: [
                    'create',
                ],
                payloadMode: [
    ...
    },
    {
        ...
        displayOptions: {
            show: {
                resource: paymentDocumentResources,
                operation: [
                    'create',
                ],
                payloadMode: [
