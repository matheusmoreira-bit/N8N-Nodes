...
export const integrationRdvDescription: IntegrationProperties = [
    {
        displayName: 'Empresa',
        name: 'companyId',
        type: 'options',
    ...
    },
    {
        ...
        description: 'O id de relatório de despesa na Onfly.',
    },
    {
    ...
    {
        displayName: 'Valor reembolsável',
        ...
        description: 'O valor reembolsável do total do relatório.',
    },
    {
        ...
        description: 'O valor adiantado do total do relatório.',
    },
    {
        displayName: 'Ids de adiantamentos vinculados',
        name: 'advancePaymentsId',
        type: 'json',
        default: '',
        required: true,
        displayOptions: {
        ...
        description: 'Array de ids de adiantamentos vinculados ao RDV Onfly.',
    },
    {
    ...
    {
        displayName: 'Opções de Cartão Corporativo',
        name: 'cardOptions',
        type: 'fixedCollection',
        placeholder: 'Adicionar cartão corporativo',
        default: '',
        required: true,
        typeOptions: {
        ...
        options: [
            {
                name: 'card',
                displayName: 'Cartão Corporativo',
                values: [
                    {
                        displayName: 'Ids de despesas de cartão vinculados',
                        name: 'blueExpendituresId',
                        type: 'json',
                        default: '',
                        required: true,
                        description: 'Array de ids de despesas de cartão vinculados ao RDV Onfly.',
                    },
                ],
            },
        ],
                                ...
                                values: [
                                    {
                                        ...
                                        default: '',
                                        required: true,
                                        description: 'O nome do campo dinâmico a ser preenchido no ITEM do endpoint PurchaseInvoices.',
                                    },
                                    {
                                        displayName: 'Valor a ser preenchido',
                                        name: 'value',
                                        ...
                                        default: '',
                                        required: true,
                                        description: 'O valor a ser preenchido no campo dinâmico no ITEM do endpoint PurchaseInvoices.',
                                    },
                                ],
                            },
                        ],
