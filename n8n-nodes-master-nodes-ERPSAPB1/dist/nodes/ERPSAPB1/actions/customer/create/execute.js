...
async function create(api, index) {
    ...
    if (!cardName) {
        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Nome do cliente é obrigatório para criar PN no SAP B1.', { itemIndex: index });
    }
    const address = {
    ...
    const customer = (0, ERPSAPB1Builders_1.applyDynamicFields)({
