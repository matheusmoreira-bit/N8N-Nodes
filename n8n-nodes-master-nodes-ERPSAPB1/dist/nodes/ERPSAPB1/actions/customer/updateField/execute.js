...
async function updateField(api, index) {
    ...
    try {
        ...
        await api.updateCustomerField(cardCode, fieldName, fieldValue);
        ...
        throw new n8n_workflow_1.NodeOperationError(this.getNode(), error instanceof Error ? error.message : 'Nao foi possivel editar o cliente.');
    }
}
